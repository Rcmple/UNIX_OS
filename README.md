# Gitlab CI для семинара 6

## Использование

Чтобы проверить ваши решения на этих скриптах, вам необходимо скопировать
все файлы данной ветки в ветку, соответствующую задачам с семинара 6.
...
Нужны два файла с исходным кодом и имя создаваемого файла fifo
(артефакта работы программы). Программы будут запущены в обоих возможных
порядках, файл будет удаляться после некоторых запусков.
